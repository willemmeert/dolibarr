 ...
 */
class pdf_mmtpropm extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "MMTpropM";
		$this->description = $langs->trans('DocModelMMTPropMDescription');
	...
	protected function _signature_area(&$pdf, $object, $posy, $outputlangs)
	{
		...
		$pdf->SetFont('', '', $default_font_size - 1);        
        $pdf->MultiCell($largcol, $tab_hl, $outputlangs->transnoentities("ProposalCondMach"), 0, 'L');
